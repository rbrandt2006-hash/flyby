              ...
              <SheetHeader className="text-left pb-6">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl bg-secondary flex items-center justify-center">
                    {(() => {
                      const CategoryIcon = categoryIcons[selectedExpense.category];
                  ...
                  <div>
                    ...
                    <Badge variant={statusConfig[selectedExpense.status].variant} className="mt-1">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{selectedExpense.location}</p>
                    </div>
                  </div>
                  <Separator />
                  <div>
                    ...
                    <CardContent className="p-4 flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          Amount exceeds policy limits for meal expenses. Please provide additional documentation.
                        </p>
                      </div>
                    </CardContent>
                  </Card>
