...
interface ChannelsContainerProps {
  ...
  connectedPlatforms: { slack: boolean; teams: boolean };
}
...
export function ChannelsContainer({
  ...
  return (
    <div className="h-full flex flex-col bg-secondary/30 rounded-2xl border border-border/40 shadow-sm overflow-hidden">
      {/* Connection Status */}
